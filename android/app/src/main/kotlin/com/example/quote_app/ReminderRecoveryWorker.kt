...
class ReminderRecoveryWorker(ctx: Context, params: WorkerParameters) : Worker(ctx, params) {
    override fun doWork(): Result {
        ...
        try { HealthDietReminderNative.restore(applicationContext) } catch (_: Throwable) { failed = true }
    ...
    companion object {
        fun enqueue(ctx: Context) {
            ...
            WorkManager.getInstance(ctx).enqueueUniqueWork("module_reminder_recovery", ExistingWorkPolicy.KEEP,
