...
class EvidenceGrowthKnowledge {
  ...
  static const String promptVersion = 'eg-p2.7-guidance.2';
  ...
  static const operatorBySource = <String, String>{
    ...
    'B05': 'SAFE_EXPOSURE', 'B06': 'SOURCE_PRACTICE',
    'B-AUDIT-01': 'SOURCE_PRACTICE', 'B-AUDIT-02': 'SOURCE_PRACTICE',
    ...
    'G03': 'SELF_CONCORDANCE_CHECK', 'G04': 'SOURCE_PRACTICE',
    'G05': 'GAP_OPERATOR', 'G06': 'SOURCE_PRACTICE',
    'G-AUDIT-05': 'PRIORITY_CUT', 'G-AUDIT-09': 'SOURCE_PRACTICE',
    ...
    'A-AUDIT-07': 'SOURCE_PRACTICE', 'A-AUDIT-08': 'SOURCE_PRACTICE',
    ...
    'F-AUDIT-01': 'FAILURE_REFRAME', 'F-AUDIT-03': 'SOURCE_PRACTICE',
    ...
    'R-AUDIT-08': 'ROLE_MODEL_TRANSFER', 'R-AUDIT-09': 'SOURCE_PRACTICE',
    'C01': 'REPETITION_PLAN', 'C02': 'SOURCE_PRACTICE', 'C03': 'SOURCE_PRACTICE',
    'C04': 'NEXT_TRIAL', 'C05': 'CONTEXT_REDESIGN', 'C06': 'SOURCE_PRACTICE',
    'C07': 'RECOVERY_MEASURE', 'C-AUDIT-04': 'SOURCE_PRACTICE',
    ...
    'G-EXT-01': 'SOURCE_PRACTICE', 'G-EXT-02': 'SOURCE_PRACTICE',
    'G-EXT-03': 'SOURCE_PRACTICE', 'A-EXT-01': 'SOURCE_PRACTICE',
    ...
    'R-EXT-04': 'SOURCE_PRACTICE', 'C-EXT-01': 'SOURCE_PRACTICE',
    'C-EXT-02': 'THEORY_IN_USE_CHECK', 'C-EXT-03': 'SOURCE_PRACTICE',
    ...
    'F-EXT2-01': 'SOURCE_PRACTICE', 'F-EXT2-02': 'RISK_DOWNSCALE',
  ...
  static EvidenceKNode _fromSource(Map<String, Object> card) {
    ...
    return EvidenceKNode(
      id: 'KB35-$original', version: 5, module: module,
